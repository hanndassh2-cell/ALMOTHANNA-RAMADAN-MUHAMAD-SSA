...
export const CardShell: React.FC<CardShellProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`sticky top-0 z-20 flex cursor-default items-center justify-between rounded-t-lg px-2 py-1 transition-all backdrop-blur-xl ${
          isActive
      ...
      >
        <div className="flex items-center gap-2 w-full min-w-0">
          <div className="cursor-grab p-0.5 text-slate-300 transition hover:text-slate-600 active:cursor-grabbing dark:text-slate-600 dark:hover:text-slate-300" title="اسحب لإعادة ترتيب البطاقة">
