...
export const TopBar: React.FC<TopBarProps> = ({
  ...
  return (
    <div className="flex items-center justify-between bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 px-4 py-2 border-b border-slate-200 dark:border-slate-800 shadow-2xs z-30 shrink-0 text-xs select-none">
      ...
      <div className="hidden lg:flex items-center gap-2">
        <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200/80 dark:border-emerald-800/80 text-[11px] font-extrabold text-emerald-700 dark:text-emerald-300 shadow-2xs">
          <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></div>
          <span>تم الحفظ • {lastSaved || "14:32"}</span>
        </div>
      </div>
