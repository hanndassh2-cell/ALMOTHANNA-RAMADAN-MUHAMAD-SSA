...
export const FullPageOcrPipeline: React.FC<FullPageOcrPipelineProps> = ({
  ...
  const availableUnits = selectedSubject === "all" ? [] : units.filter((u) => u.subjectId === selectedSubject);
  const availableLessons = selectedUnit === "all" ? [] : lessons.filter((l) => l.unitId === selectedUnit);
