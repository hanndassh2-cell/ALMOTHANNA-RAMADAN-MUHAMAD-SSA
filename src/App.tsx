...
import { CurriculumTreeView } from "./modules/curriculum/pages/CurriculumTreeView";
...
export function App() {
  ...
  const handleSaveExam = (exam: Exam) => {
    ...
    if (!canPerformAction(currentUser, isEdit ? "edit" : "generate", "exams") || !canAccessSubject(currentUser, exam.subjectId)) {
  ...
  const handleDeleteExam = (id: string) => {
    ...
    if (!canPerformAction(currentUser, "delete", "exams") || (exam && !canAccessSubject(currentUser, exam.subjectId))) {
  ...
  const handleExportBackup = () => {
    ...
    a.download = `edutech-backup-${dateStr}_${timeStr}.json`;
    a.click();
