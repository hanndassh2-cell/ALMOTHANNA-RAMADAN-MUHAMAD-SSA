  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <button
          onClick={onExportPdf}
          className="flex items-center gap-1.5 px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs rounded-lg transition-colors shadow-xs active:scale-95 cursor-pointer shrink-0"
        ...
        {/* Pilot PDF V2 Export Button */}
        {onExportPdfV2 && (
          <button
            onClick={onExportPdfV2}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white font-bold text-xs rounded-lg transition-all shadow-xs active:scale-95 cursor-pointer shrink-0 border border-indigo-400/30"
            title="تصدير المستند كملف PDF تجريبي بمسار V2 المستقل"
          >
            <Sparkles className="w-3.5 h-3.5 text-amber-300 animate-pulse" />
            <span className="hidden sm:inline">تصدير PDF تجريبي</span>
            <span className="sm:hidden">PDF تجريبي</span>
          </button>
        )}
        ...
        <div className="relative shrink-0" ref={exportMenuRef}>
          ...
          {isExportOpen && (
            <div className="absolute right-0 top-full mt-1.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-2xl py-1.5 z-50 w-60 text-right animate-in fade-in zoom-in-95 duration-150">
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-[9px] bg-violet-100 dark:bg-violet-900/60 text-violet-700 dark:text-violet-300 px-1 py-0.2 rounded font-mono font-bold">V2 Pilot</span>
                    </div>
                    <span className="text-[10px] text-slate-400 font-normal">محرك تصدير مستقل عالي الدقة</span>
                  </div>
                </button>
              )}
              <button
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-slate-400 font-normal">تحميل كل صورة بشكل مستقل</span>
                </div>
              </button>
            </div>
          )}
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="grid grid-cols-2 gap-1">
                          {[
                            ...
                            { id: "ultra-compact", label: "فائق الدمج (Max Save)" },
                          ].map((den) => (
                            <button
                              key={den.id}
                              type="button"
